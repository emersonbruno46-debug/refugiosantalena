        ...
        <div className="relative rounded-xl overflow-hidden border border-dk-border bg-dk-bg h-[480px] sm:h-[600px] shadow-2xl">
          ...
          <div className="absolute inset-8 sm:inset-16 border border-limestone/20 pointer-events-none flex flex-col justify-between p-4">
            ...
            <div className="self-center flex flex-col items-center gap-2">
              ...
              <div className="font-sans text-[11px] text-dk-text bg-dk-bg/90 px-3.5 py-1 border border-dk-border rounded-full text-center backdrop-blur-md font-medium tracking-wide">
          ...
          {/* Bottom Caption Bar */}
          <div className="absolute bottom-6 left-6 right-6 font-sans text-xs text-dk-secondary-text bg-dk-bg/90 backdrop-blur-md p-4 border border-dk-border rounded-full px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <Mountain className="w-5 h-5 text-hl-moss" />
              <div>
                <span className="text-dk-text font-bold block">Complexo Pedras do Baú</span>
            ...
            <div className="flex items-center gap-2 text-right">
              ...
              <span className="text-dk-text text-[11px] font-medium">Bairro Paiol Grande — SP</span>
            </div>
          </div>
        </div>
      </div>
