    ...
    <section className="py-24 px-4 sm:px-8 bg-summit relative overflow-hidden border-t border-graphite">
      ...
      <div className="max-w-7xl mx-auto relative z-10 space-y-16">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-rock/30 pb-8">
          <div>
            ...
            <h2 className="font-display font-medium text-3xl sm:text-5xl text-paper tracking-tight leading-tight max-w-3xl">
              ...
              <span className="block text-signal mt-2">No meio, o lugar onde você fica.</span>
            </h2>
          </div>

          <div className="flex flex-col items-start md:items-end gap-3 font-sans text-xs">
            <span className="px-3.5 py-1 bg-graphite text-paper border border-rock/40 rounded-full font-medium tracking-wide">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          {/* Main Panorama Image */}
          <div className="lg:col-span-7 relative group rounded-lg overflow-hidden border border-rock/30 bg-graphite min-h-[400px] lg:min-h-[500px]">
            <img
            ...
            <div className="absolute bottom-6 left-6 right-6 font-sans text-xs text-paper bg-summit/85 backdrop-blur-md p-4 border border-rock/40 rounded-sm flex items-center justify-between">
              <div>
                <span className="block text-[10px] text-limestone uppercase tracking-wider">VISTA DO DECK</span>
                <span className="font-semibold text-paper">Pedra do Baú ao Pôr do Sol</span>
              </div>
              <span className="text-signal font-bold">FASE / 01</span>
            </div>
          </div>

          {/* Side Content Block */}
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-graphite/60 border border-rock/30 p-8 rounded-lg space-y-6">
              ...
              <div className="space-y-4 pt-4 border-t border-rock/30 font-sans text-xs">
                <div className="flex items-start gap-3">
                  <Droplets className="w-5 h-5 text-signal shrink-0 mt-0.5" />
                  <div>
                    <strong className="text-paper block">Jacuzzi Privativa com Teto de Vidro</strong>
                ...
                <div className="flex items-start gap-3">
                  <Flame className="w-5 h-5 text-signal shrink-0 mt-0.5" />
                  <div>
                    <strong className="text-paper block">Lareira Interna & Fogueira Externa</strong>
                    <span className="text-limestone text-[11px]">
                ...
                <div className="flex items-start gap-3">
                  <Eye className="w-5 h-5 text-signal shrink-0 mt-0.5" />
                  <div>
                    <strong className="text-paper block">Banheiro Panorâmico</strong>
                    <span className="text-limestone text-[11px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="relative group rounded-lg overflow-hidden border border-rock/30 bg-graphite h-72">
            <img
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-summit/80 via-transparent to-transparent"></div>
            <div className="absolute bottom-3 left-3 right-3 font-sans text-[11px] text-paper bg-summit/80 p-2 rounded-full text-center tracking-wide font-medium border border-rock/20">
        ...
        {/* CTA Bar */}
        <div className="bg-graphite p-8 border border-rock/40 rounded-lg flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h4 className="font-display font-medium text-2xl text-paper mb-1">
              Pronto para se hospedar no Kilimanjaro?
            </h4>
            <p className="font-sans text-xs text-limestone">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-full md:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 bg-deep-forest hover:bg-forest text-warm-cream font-sans text-xs font-bold uppercase tracking-wider rounded-full transition-all shadow-lg shadow-deep-forest/20 shrink-0"
          >
